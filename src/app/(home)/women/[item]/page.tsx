                ...
                <div className={`${styles.itemDetails} col-xxl-8 col-xl-8 col-lg-8 col-md-12 col-sm-12 col-12 p-xxl-3 p-xl-3 p-lg-3 p-md-3 p-2`} >
                  ...
                  <div className='mx-0 my-1 p-2 ' >
                    <div className="col-12">
                      <Link href={`/women/${item.itemId}&${item.name}/pay`} className='btn text-capitalize text-white fw-bold fs-7 fs-sm-6 fs-md-5 fs-lg-6 fs-xl-5 fs-xxl-5 m-0 p-1 w-100' style={{background:'rgba(171, 93, 2, 1)'}}>
                        pay now
                      </Link>
                    </div>
                  </div>
